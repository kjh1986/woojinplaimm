...
<script>
	$(document).ready(function() {
		if("${code}"=="100"){
			window.alert("과정입력이 완료 되었습니다.");
		}else if("${code}"=="101"){
			window.alert("과정입력이 실패했습니다.");
		}else if("${code}"=="200"){
			window.alert("과정수정이 완료 되었습니다.");
		}else if("${code}"=="201"){
			window.alert("과정수정이 실패했습니다.");
		}else if("${code}"=="300"){
			window.alert("과정삭제가 완료 되었습니다.");
		}else if("${code}"=="301"){
			window.alert("과정삭제가 실패했습니다.");
		}
		
		//수정액션리스너 
		$("button.btn-courseInfo").on("click",function(){
			var course_id = $(this).attr("value");
			var course_name = $(this).parents("tr").children(":nth-child(2)").text();
			
			$("#infoModal input#course_id").val(course_id);
			$("#infoModal input[name=course_id]").val(course_id);
			$("#infoModal input#course_name").val(course_name);
			$("#infoModal").modal();
		});

		//삭제액션리스너 
		$("button.btn-courseDelete").on("click",function(){
			var course_id = $(this).attr("value");
			var course_name = $(this).parents("tr").children(":nth-child(2)").text();
			
			$("#deleteModal input#course_id").val(course_id);
			$("#deleteModal input[name=course_id]").val(course_id);
			...
			<div class="col-md-2 sidenav" style="padding: 0px;">
				<div class="list-group">
					...
					<div class="list-group collapse in" id="basicCallapse">
						...
						<a class="list-group-item active" href="${pageContext.request.contextPath}/basicInfo/courseList">과정목록</a>
		...
		<div class="panel-body">
				...
				<tbody>
					<c:forEach var = "bi" items="${tableData}">
						<tr>
							...
							<td><button class="btn btn-default btn-sm btn-courseInfo" value="${bi.course_id}">수정</button></td>
							<td><button class="btn btn-danger btn-sm btn-courseDelete" value="${bi.course_id}">삭제</button></td>
			...
			<div class="form-inline" style="float:right" >
				...
				<select class="form-control" name="key" id="key">
					<option value="course_id">과정번호</option>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">과정상세정보</h4>
				</div>
				<div class="modal-body">
					<form action="${pageContext.request.contextPath}/basicInfo/courseUpdate" method="POST" class="form-inline" id="courseInfo">
						<div class="row">
							<div class="col-md-4" style="text-align: right">
								<label for="course_id">No : </label><br>
								<label for="course_name">과정명 : </label><br>
							</div>
							<div class="col-md-6">
								<input type="text" class="form-control" id="course_id" disabled>
	...
	<div id="deleteModal" class="modal fade" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title">과정상세정보-삭제</h4>
				</div>
				<div class="modal-body">
					<form action="${pageContext.request.contextPath}/basicInfo/courseDelete" class="form-inline" method="POST">
						<div class="row">
							<div class="col-md-4" style="text-align: right">
								<label for="course_id">No : </label><br>
								<label for="course_name">과정명 : </label><br>
	...
	<div id="insertModal" class="modal fade" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-inline" action="${pageContext.request.contextPath}/basicInfo/courseInsert" method="POST">
						<div class="row">
							<div class="col-md-4" style="text-align: right">
